...
const X_MASK: i64 = 0b11111111111111111111;
const Y_MASK: i64 = 0b1111111111111111111100000000000000000000;
const Z_MASK: i64 = 0b111111111111111111110000000000000000000000000000000000000000;

const X_MASK2: i64 = 0b111111111111111111111111111111;
const Y_MASK2: i64 = 0b111111111111111111111111111111000000000000000000000000000000;

#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord, Reflect)]
pub struct QVec3(pub i64);
