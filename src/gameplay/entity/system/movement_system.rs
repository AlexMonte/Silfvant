...
pub fn movement(mut query: Query<(&mut Transform, &mut Coordinates, &Velocity)>, time: Res<Time>) {
...
pub fn update_transforms(mut query: Query<(&mut Transform, &mut Coordinates)>) {
